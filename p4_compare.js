...
const data = names.map(async (name) => {
...
const fulfilled = results.filter((s) => s.status === "fulfilled");

//rejected는 이름을 따로 기억하기 위하여 map을 활용하였음
const rejected = results
.map((result, i) => ({result, name: names[i]}))
